...
import { useAddPoint, useUploadFile } from "src/app/services/points.service";
...
const PointFile: React.FC = () => {
  const { setValues, values, id, setIds, clearValues } = useGetPointData();
