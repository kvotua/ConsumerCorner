...
import { useEditPoint, useGetPointById } from "@/root/services/points";
import { IPointAdd } from "@/root/types/point";
...
const PointEditForm: React.FC = () => {
  ...
  const onSubmit = async (data: Partial<IPointAdd>) => {
    mutate({ body: data as IPointAdd, pointId: pointId as string });
  };
  return (
    <form
